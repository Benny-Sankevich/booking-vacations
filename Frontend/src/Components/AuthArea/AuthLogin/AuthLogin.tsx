...
import { userLoggedInAction } from "../../../Redux/UsersState";
...
//User login function
function AuthLogin(props: AuthLoginProps): JSX.Element {
    ...
    async function send(user: UsersModel) {
        try {
            const response = await Axios.post<UsersModel>(Globals.authUrl + "login", user);
        ...
        <Container component="main" maxWidth="xs">
            ...
            <div className={classes.paper}>
                ...
                <form className={classes.form} onSubmit={handleSubmit(send)}>
                    <TextField variant="outlined" margin="normal" required fullWidth inputRef={register} label="Username" name="username" type="text" autoComplete="username" inputProps={{ minLength: 2, maxLength: 30 }} autoFocus />
